        ...
        <div className="glass hover:glass-hover rounded-2xl overflow-hidden transition-all duration-300 border border-glass-border group-hover:border-primary/30">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-2">
              ...
              scale: 0.9
            }} className="p-2 glass rounded-full text-white hover:text-primary transition-colors" aria-label="Add to wishlist">
              ...
              scale: 0.9
            }} className="p-2 glass rounded-full text-white hover:text-primary transition-colors" aria-label="Quick view">
                <Eye className="w-5 h-5" />
              </motion.button>
            </div>

            {/* Stock Status */}
            {!product.inStock && <Badge className="absolute top-3 left-3 bg-destructive/90">
                Out of Stock
              </Badge>}
