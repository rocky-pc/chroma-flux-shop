        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-instagram bg-clip-text text-transparent"
            >
            ...
            >
              <Link to="/products">
                <Button
                  size="lg"
                  className="bg-gradient-instagram hover:shadow-xl hover:shadow-primary/25 transition-all duration-300 text-lg px-8 py-6"
                >
                  Explore Products
              ...
              <Button
                variant="outline"
                size="lg"
                className="glass border-glass-border hover:glass-hover text-lg px-8 py-6"
              >
                Watch Demo
              </Button>
            </motion.div>
          ...
          >
            <Link to="/products">
              <Button
                size="lg"
                variant="outline"
                className="glass border-glass-border hover:glass-hover"
              >
                View All Products
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/products">
                <Button
                  size="lg"
                  className="bg-gradient-instagram hover:shadow-xl hover:shadow-primary/25 transition-all duration-300"
                >
                  Start Shopping
                </Button>
              </Link>
